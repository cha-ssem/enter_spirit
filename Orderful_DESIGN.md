...
|------|-------|-------|------|
| Vermillion Signal | `linear-gradient(94deg, rgb(35, 70, 255) -33.85%, rgb(0, 170, 255) -1.54%, rgb(35, 70, 255) 73.55%)` | `--color-vermillion-signal` | Action color for filled buttons, selected navigation states, and focused conversion moments. |
...
Background uses the signal gradient (linear-gradient(94deg, rgb(35, 70, 255) -33.85%, rgb(0, 170, 255) -1.54%, rgb(35, 70, 255) 73.55%)). White uppercase text in telegraf 14px weight 600, 0.025em tracking, 8px radius, padding 12px 20px. Visually distinct from all other vermillion buttons — reserved for nav only.
...
:root {
  ...
  --gradient-vermillion-signal: linear-gradient(94deg, rgb(35, 70, 255) -33.85%, rgb(0, 170, 255) -1.54%, rgb(35, 70, 255) 73.55%);
